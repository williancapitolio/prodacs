...
";
	...
	$result_resultado = "INSERT INTO preventivos (`data`, `fam`, `nome`, `data_nasc`, `status`) VALUES ('$data', '$fam', '$nome', '$data_nasc', '1')";
...
<body> <?php
		if (mysqli_affected_rows($conn) != 0) {
			echo "
				<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=http://localhost/prodacs/preventivo.php'>
				<script type=\"text/javascript\">
