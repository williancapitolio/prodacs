...
<head>
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function() {
            $('#listar-marcacao_exame').DataTable({
                //dom: "Bfrtip",
                "processing": true,
                "serverSide": true,
                //"ajax": {
                ...
                "bDeferRender": true,
                "ajax": {
                    "url": "marcacao_exame_pesquisa.php",
                    "type": "POST"
                },
...
<body role="document">
    ...
    <div class="container theme-showcase" role="main">
        <div class="page-header">
            <div class="row">
                ...
                <div class="btn-group pull-right">
                    <button type="button" class="btn btn-success pull-right menu" data-toggle="modal" data-target="#inserirMarcacaoModal">
                        Inserir Registro
                    </button>

                    <!-- Modal -->
                    <div class="modal fade" id="inserirMarcacaoModal" tabindex="-1" role="dialog" aria-labelledby="inserirMarcacaoModalLabel">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <h4 class="modal-title text-center" id="inserirMarcacaoModalLabel">Inserir Marcação de Exame</h4>
                                </div>
                                <div class="modal-body">
                                    <form method="POST" action="http://localhost/prodacs/marcacao_exame_cadastra.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Local do Exame</label>
                                            <div class="col-sm-10">
                                                <input name="exame_local" type="text" class="form-control" id="exame_local" placeholder="Local do Exame" required>
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Data do Exame</label>
                                            <div class="col-sm-10">
                                                <input name="exame_data" type="date" class="form-control" id="exame_data" placeholder="Data do Exame" required pattern="^([0-2][0-9]|(3)[0-1])(\/)(((0)[0-9])|((1)[0-2]))(\/)\d{4}$" title="Preencha desta forma: DD/MM/AAAA">
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Hora do Exame</label>
                                            <div class="col-sm-10">
                                                <input name="exame_hora" type="text" class="form-control" id="exame_hora" placeholder="Hora do Exame" required pattern="(0[0-9]|1[0-9]|2[0-3])(:[0-5][0-9]){2}" title="Preencha desta forma: HH:MM:SS">
                                            </div>
                                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <table id="listar-marcacao_exame" class="display" style="width:100%">
                    <thead>
                        <tr>
                            <th>Família</th>
                            <th>Nome</th>
        ...
        <!-- DATATABLE -->
        <a href="marcacao_exame_pdf.php" class="btn btn-default"><span class="glyphicon glyphicon-download-alt text-info" aria-hidden="true" style="cursor:pointer;" title="Gerar PDF"></span></a>
