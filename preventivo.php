...
<body role="document">
    ...
    <div class="container theme-showcase" role="main">
        <div class="page-header">
            <div class="row">
                ...
                <div class="btn-group pull-right">
                    <button type="button" class="btn btn-success pull-right menu" data-toggle="modal" data-target="#inserirPreventivoModal">
                        Inserir Registro
                    </button>

                    <!-- Modal -->
                    <div class="modal fade" id="inserirPreventivoModal" tabindex="-1" role="dialog" aria-labelledby="inserirPreventivoModalLabel">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <h4 class="modal-title text-center" id="inserirPreventivoModalLabel">Inserir Preventivo</h4>
                                </div>
                                <div class="modal-body">
                                    <form method="POST" action="http://localhost/prodacs/preventivo_cadastra.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="data" type="date" class="form-control" id="data" placeholder="Data da coleta" required pattern="^([0-2][0-9]|(3)[0-1])(\/)(((0)[0-9])|((1)[0-2]))(\/)\d{4}$" title="Preencha desta forma: DD/MM/AAAA">
                                            </div>
                                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <table id="listar-preventivo" class="display" style="width:100%">
                    <thead>
                        <tr>
        ...
        <!-- DATATABLE -->
        <a href="preventivo_pdf.php" class="btn btn-default"><span class="glyphicon glyphicon-download-alt text-info" aria-hidden="true" style="cursor:pointer;" title="Gerar PDF"></span></a>
