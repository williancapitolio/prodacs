...
$result_usuario = "SELECT * FROM cadastros_inclusoes ORDER BY data ASC";
...
// Carrega seu HTML
$dompdf->loadHtml('
			<h1 style="text-align: center;">ProdACS - Relatório de Cadastros e Inclusões</h1>
			'. $html .'
		');
