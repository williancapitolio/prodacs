...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB8sX0-gmKb-RimlIRtsRvkKbVIXRal3Vo&callback=initMap">
</script>
...
<script>
    ...
    var myOptions = {
        zoom: 13,
        center: new google.maps.LatLng(-20.650011, -46.047370),
        mapTypeId: 'satellite',
    ...
    var addMarker = google.maps.event.addListener(map, 'dblclick', function(e) {
        ...
        var marker = new google.maps.Marker({
            ...
            html: "    <div id='info_" + markerId + "'>\n" +
                ...
                "                <td><textarea  id='manual_description' placeholder='Número da família' aria-required='true'></textarea></td></tr>\n" +
    ...
    for (i = 0; i < locations.length; i++) {
        marker = new google.maps.Marker({
            ...
            html: "<div>\n" +
                "<table class=\"map1\">\n" +
                "<input name='id' type='hidden' id='" + locations[i][0] + "' />\n" +
                "<tr>\n" +
                "<td><b>Logradouro: </b></td>\n" +
                "<td><label disabled id='manual_description' placeholder='Número '>" + locations[i][3] + "</label></td></tr>\n" +
                //"<td><input type='button' value='Apagar' onclick='delete_location(" + locations[i][0] + ")'></td>\n" +
                "<td><b>Ações: </b></td>\n" +
                "<td><a href='vizualizar_marcador.php?id=" + locations[i][0] + "&description=" + locations[i][3] + "'><span class='glyphicon glyphicon-eye-open text-info' aria-hidden='true' style='cursor:pointer;' title='Vizualizar'></span></a></td>\n" +
                "<td><a href='apagar_marcador.php?id=" + locations[i][0] + "'><span class='glyphicon glyphicon-trash text-danger text-info' aria-hidden='true' style='cursor:pointer;' title='Apagar'></span></a></td>\n" +
                "</table>\n" +
                "</div>"
    ...
    function saveData(lat, lng) {
        ...
        downloadUrl(url, function(data, responseCode) {
            if (responseCode === 200 && data.length > 1) {
                ...
                window.location.replace("http://localhost/prodacs/admin-map.php");
