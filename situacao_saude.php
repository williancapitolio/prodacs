...
<head>
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function() {
            $('#listar-situacao_saude').DataTable({
                //dom: "Bfrtip",
                "processing": true,
                "serverSide": true,
                //"ajax": {
                ...
                "bDeferRender": true,
                "ajax": {
                    "url": "situacao_saude_pesquisa.php",
                    "type": "POST"
                },
...
<body role="document">
    ...
    <div class="container theme-showcase" role="main">
        <div class="page-header">
            <div class="row">
                ...
                <div class="btn-group pull-right">
                    <button type="button" class="btn btn-success pull-right menu" data-toggle="modal" data-target="#inserirSitSauModal">
                        Inserir Registro
                    </button>

                    <!-- Modal -->
                    <div class="modal fade" id="inserirSitSauModal" tabindex="-1" role="dialog" aria-labelledby="inserirSitSauModalLabel">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <h4 class="modal-title text-center" id="inserirSitSauModalLabel">Inserir Situação de Saúde</h4>
                                </div>
                                <div class="modal-body">
                                    <form method="POST" action="http://localhost/prodacs/situacao_saude_cadastra.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="endereco" type="text" class="form-control" id="endereco" placeholder="Endereço completo" required>
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Situação de Saúde</label>
                                            <div class="col-sm-10">
                                                <input name="comorbidade" type="text" class="form-control" id="comorbidade" placeholder="Situação de saúde" required>
                                            </div>
                                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <table id="listar-situacao_saude" class="display" style="width:100%">
                    <thead>
                        <tr>
                            <th>Família</th>
                            <th>Nome</th>
        ...
        <!-- DATATABLE -->
        <a href="situacao_saude_pdf.php" class="btn btn-default"><span class="glyphicon glyphicon-download-alt text-info" aria-hidden="true" style="cursor:pointer;" title="Gerar PDF"></span></a>
