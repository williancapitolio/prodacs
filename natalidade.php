...
<body role="document">
    ...
    <div class="container theme-showcase" role="main">
        <div class="page-header">
            <div class="row">
                ...
                <div class="btn-group pull-right">
                    <button type="button" class="btn btn-success pull-right menu" data-toggle="modal" data-target="#inserirNatalidadeModal">
                        Inserir Registro
                    </button>

                    <!-- Modal -->
                    <div class="modal fade" id="inserirNatalidadeModal" tabindex="-1" role="dialog" aria-labelledby="inserirNatalidadeModalLabel">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <h4 class="modal-title text-center" id="inserirNatalidadeModalLabel">Inserir Natalidade</h4>
                                </div>
                                <div class="modal-body">
                                    <form method="POST" action="http://localhost/prodacs/natalidade_cadastra.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="nome_mae" type="text" class="form-control" id="nome_mae" placeholder="Nome completo da mãe" required pattern="[a-zA-Z\s]+" title="Apenas letras e sem caracteres especiais">
                                            </div>
                                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <table id="listar-natalidade" class="display" style="width:100%">
                    <thead>
                        <tr>
                            <th>Família</th>
                            <th>Nome</th>
        ...
        <!-- DATATABLE -->
        <a href="natalidade_pdf.php" class="btn btn-default"><span class="glyphicon glyphicon-download-alt text-info" aria-hidden="true" style="cursor:pointer;" title="Gerar PDF"></span></a>
